const countingSort = require("./counting-sorting-one");
...
describe("Test countingSort", () => {
  ...
  testArrTwo = [1, 1, 3, 2, 1];
  solutionTwo = [0, 3, 1, 1];

  it("test one", () => {
    expect(countingSort(testArrOne)).toEqual(solutionOne);
  });

  it("test two", () => {
    expect(countingSort(testArrTwo, 4)).toEqual(solutionTwo);
  });
});
